...
navigator.geolocation.getCurrentPosition(function (position) {
    ...
    map.on('click', function (event) {
        ...
        console.log("string",locationString)
        ...
        document.getElementById("fromLatitude").value = currentLocation[1].toString();
        document.getElementById("fromLongitude").value = currentLocation[0].toString();
        document.getElementById("toLatitude").value = newLocation[1].toString();
        document.getElementById("toLongitude").value = newLocation[0].toString();
        console.log('madarchod2');
